...
public class ProductDAOImpl implements ProductDAO {
    ...
    public boolean delete(int ID) throws Exception {
        ...
        // Delete related records from order_details first
        Query deleteOrderDetails = session.createQuery("DELETE FROM OrderDetail WHERE product.productId = :productId");
        deleteOrderDetails.setParameter("productId", ID);
        deleteOrderDetails.executeUpdate();

        // Now delete the product
        Query deleteProduct = session.createQuery("DELETE FROM Product WHERE productId = :productId");
        deleteProduct.setParameter("productId", ID);
